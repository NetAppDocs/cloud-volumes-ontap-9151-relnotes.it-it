...
| Tipi di dischi supportati 3+| Dischi gestiti con HDD standard, dischi gestiti con SSD standard, dischi gestiti con SSD Premium e dischi gestiti con SSD Premium da v2 GB. 
|===
Note:
