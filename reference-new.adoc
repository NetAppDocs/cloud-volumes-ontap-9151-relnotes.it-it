...
La patch 9.15.1 P14 è ora disponibile per Cloud Volumes ONTAP per tutti i provider cloud. NetApp Console ti chiederà di aggiornare i tuoi sistemi esistenti a questa versione di patch.
...
La patch 9.15.1 P13 è ora disponibile per Cloud Volumes ONTAP per tutti i provider cloud. NetApp Console ti chiederà di aggiornare i tuoi sistemi esistenti a questa versione di patch.
